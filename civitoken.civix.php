...
function _civitoken_civix_civicrm_xmlMenu(&$files) {
  foreach (_civitoken_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 */
function _civitoken_civix_civicrm_install() {
 ...
 */
function _civitoken_civix_civicrm_uninstall() {
  _civitoken_civix_civicrm_config();
  if ($upgrader = _civitoken_civix_upgrader()) {
 ...
 */
function _civitoken_civix_civicrm_enable() {
  _civitoken_civix_civicrm_config();
  if ($upgrader = _civitoken_civix_upgrader()) {
 ...
 * @return mixed
 */
function _civitoken_civix_civicrm_disable() {
  _civitoken_civix_civicrm_config();
  if ($upgrader = _civitoken_civix_upgrader()) {
 ...
 */
function _civitoken_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _civitoken_civix_upgrader()) {
 ...
 * @return array
 */
function _civitoken_civix_find_files($dir, $pattern) {
  ...
  while (!empty($todos)) {
    ...
    foreach (_civitoken_civix_glob("$subdir/$pattern") as $match) {
      if (!is_dir($match)) {
        $result[] = $match;
      }
    }
 ...
 */
function _civitoken_civix_civicrm_caseTypes(&$caseTypes) {
  if (!is_dir(__DIR__ . '/xml/case')) {
    return;
  }

  foreach (_civitoken_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
 ...
 */
function _civitoken_civix_civicrm_themes(&$themes) {
  $files = _civitoken_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 * @return array
 */
function _civitoken_civix_glob($pattern) {
  $result = glob($pattern);
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _civitoken_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _civitoken_civix_civicrm_entityTypes(&$entityTypes) {
